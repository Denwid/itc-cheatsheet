...
A code $\mathcal{C}$ is a binary linear code if $x,y \in \mathcal{C}$ then $x+y \in \mathcal{C}$ and + being the componentwise modulo 2 addition. The size of the codebook is always a power of two: $|\mathcal{C}| = 2^k$.
